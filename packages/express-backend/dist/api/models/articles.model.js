...
exports.articleOptions = void 0;
exports.articleOptions = [
    {
        title: "Fed raises rates, Powell leaves door open to hike in September - Reuters",
    ...
    {
        title: "3 Marines found dead in vehicle in North Carolina died from carbon monoxide poisoning: Sheriff - ABC News",
        author: "Teddy Grant",
        source: {
            Id: "abc-news",
            Name: "ABC News",
    ...
    {
        title: "Prosecutors want Sam Bankman-Fried sent to jail after witness-tampering allegations. Judge issues gag order - CNN",
    ...
    {
        title: "Police K-9 handler who released dog that attacked an unarmed Black man in Ohio has been fired, department says - CNN",
    ...
    {
        title: "Rudy Giuliani admits making false claims of Georgia voter fraud - BBC",
    ...
    {
        title: "Watch Live: Fed Chair Jerome Powell Speaks on Interest-Rate Decision at 2:30 p.m. ET - The Wall Street Journal",
        author: "Karen Langley, WSJ Staff, Hannah Miao, Hardika Singh, David Uberti, Justin Lahart, Matt Grossman, Gunjan Banerji, Harriet Torry",
        source: {
    ...
    {
        title: "Mitch McConnell escorted away from press conference after falling silent - Yahoo News",
    ...
    {
        title: "Giants GM Joe Schoen on Saquon Barkley talks - No hard feelings - ESPN - ESPN",
    ...
    {
        title: "Miami-Dade police chief shot himself after offering resignation, mayor says - Yahoo News",
        author: "FREIDA FRISARO",
        source: {
            Id: null,
            Name: "Yahoo Entertainment",
        },
        publishedAt: "2023-07-26T17:48:07Z",
        url: "https://news.yahoo.com/miami-dade-police-chief-shot-163403427.html",
    },
    {
        title: "Israel's top court will hear challenges to a law that weakens its power, escalating political crisis - The Associated Press",
        author: "ISABEL DEBRE",
        source: {
            Id: "associated-press",
            Name: "Associated Press",
        },
        publishedAt: "2023-07-26T17:32:00Z",
        url: "https://apnews.com/article/israel-netanyahu-judicial-reform-protest-supreme-court-88593d00c3033c650d171abc619ecd79",
    },
    {
        title: "Stability AI releases its latest image-generating model, Stable Diffusion XL 1.0 - TechCrunch",
        author: "Kyle Wiggers",
        source: {
            Id: "techcrunch",
            Name: "TechCrunch",
        },
        publishedAt: "2023-07-26T17:15:00Z",
    ...
    },
    {
        ...
        publishedAt: "2023-07-26T16:49:00Z",
        url: "https://www.cnn.com/style/article/apple-sneakers-sale-intl-scli/index.html",
    },
    {
        title: "'UnIslamic services': Taliban closes beauty salons in Afghanistan despite public protest - USA TODAY",
        author: "Associated Press",
        source: {
            Id: "usa-today",
            Name: "USA Today",
        },
        publishedAt: "2023-07-26T16:48:13Z",
        url: "https://www.usatoday.com/story/news/world/2023/07/26/afghanistan-beauty-salons-closed-by-taliban/70469710007/",
    },
    {
        title: "Two pilots killed in Greece plane crash as wildfires batter Sicily - The Washington Post",
    ...
    {
        title: "Company involved in NYC crane collapse tied to previous disasters, shady 'King of Crane' - New York Post ",
        author: "Olivia Land",
        source: {
            Id: null,
            Name: "New York Post",
